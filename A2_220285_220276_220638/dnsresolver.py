"""
DNS Resolver (Explain Like I'm 5)
---------------------------------

What this script does:
  - For a domain like example.com, it can do two styles of lookup:
    1) Iterative: start at the root servers, then go to the TLD (.com), then the
       authoritative server, step by step (like the Internet’s real process).
    2) Recursive: ask your system’s resolver to do the above steps for you.

How to read this file:
  - Top‑level functions have short docstrings that say “why” and “what”.
  - Helper functions explain the small pieces (send a query, parse answers,
    handle timeouts, etc.).
  - Printouts are designed to teach: you’ll see where we are (ROOT → TLD → AUTH).
"""
