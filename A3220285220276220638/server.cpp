// ---------------------------------------------------------------------------
// server.cpp — Raw TCP handshake “listener” (ELI5 version)
// ---------------------------------------------------------------------------
// This program uses a RAW socket to observe incoming TCP SYN packets, then
// crafts and sends back a SYN‑ACK, and finally expects an ACK to finish the
// 3‑way handshake — all without the kernel’s TCP state machine. This is purely
// educational to show what happens beneath normal sockets.
// Read the printouts to see each step and each TCP flag.
// ---------------------------------------------------------------------------
#include <iostream>
#include <cstring>
#include <cstdlib>
